require './2018_day_2_part_2'



describe "2018_day_2_part_2" do
    ...
    it """should return common as  for abcde
          fghij
          klmno
          pqrst
          fguij
        ...
        input = """abcde
          ...
          wvxyz
          """
          output = @inventory_manager.get_common_code input
          expect(output).to eq 'fgij'
  end
...
jltamotqgsfnudctzbyxkhervp"""
  output = @inventory_manager.get_common_code input
  expect(output).to eq 'jiwamotgsfrudclzbyzkhlrvp'
end
