require './2017_day_2_part_2'



describe "2017_day_2_part_2" do
  
    before :each do
        @checksum = Checksum_2.new
    end
    ...
    it "should return 4. for 5 9 2 8" do
      output = @checksum.calc '5 9 2 8'
      expect(output).to eq 4
    end
    
    it "should return 7. for 5 9 2 8   9 4 7 3" do
      input = '''
5 9 2 8
9 4 7 3'''
      output = @checksum.calc input
      expect(output).to eq 7
    end

    it "should return 9. for 5 9 2 8   9 4 7 3  3 8 6 5" do
      input = '''
5 9 2 8
9 4 7 3
3 8 6 5'''
    ...
    it "should return 242 for puzzle_input" do
      input = '''
